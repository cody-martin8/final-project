        ...
        <table className="table table-striped w-75">
          <thead>
            <tr>
              ...
              <th className="d-none d-sm-none d-md-table-cell col-lg-4">Exercises</th>
              <th className="col-3">Status</th>
              <th className="d-none d-sm-none d-md-table-cell col-md-3 col-lg-3">Mark as Inactive</th>
            </tr>
          </thead>
          <tbody>
            {
...
function Patient(props) {
  ...
  return (
    <>
      ...
      <td className="d-none d-sm-none d-md-table-cell"><i className="fa-solid fa-check-to-slot ms-5"></i></td>
    </>
  );
}
